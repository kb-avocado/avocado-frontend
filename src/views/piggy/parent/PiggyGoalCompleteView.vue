  ...
  <div class="min-h-screen flex flex-col bg-white">
    ...
    <div class="flex-1 p-4 space-y-6" v-if="piggyBank">
      ...
      <div class="rounded-2xl bg-orange-400 p-6 text-center space-y-3">
        ...
        <div
          class="inline-flex items-center gap-2 bg-white/20 text-white text-sm rounded-full px-4 py-2"
        >
      ...
      <div>
        ...
        <textarea
          ...
          class="w-full border border-avocado-300 rounded-xl p-3 text-[15px] outline-none resize-none"
        ></textarea>
...
async function handleSubmit() {
  ...
  try {
    ...
    router.push({
      ...
      params: { id: piggyBank.value.piggyBankId },
      query: { amount: bonusAmount.value }
    })
  } catch (e) {
