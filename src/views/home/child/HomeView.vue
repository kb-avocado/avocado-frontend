    ...
    >
      ...
      <div class="flex items-center gap-3 w-full">
        <RouterLink
          ...
          class="flex-1 h-10 flex items-center justify-center bg-white text-sm font-medium rounded-full"
          style="color: #366a1b"
        >
          돈 보내기
        </RouterLink>
        ...
        <RouterLink
          :to="{ name: 'wallet' }"
          class="flex-1 h-10 flex items-center justify-center bg-avocado-600 text-white text-sm font-medium rounded-full"
        >
          결제하기
        </RouterLink>
      </div>
