<template>
  ...
  >
    <div class="flex flex-1 flex-col items-center justify-center">
      ...
      <p
        v-if="description"
        class="mt-3 whitespace-pre-line text-sm leading-6 text-gray-500"
      >
        {{ description }}
      </p>
      ...
      <dl
        ...
        class="mt-7 w-full rounded-2xl bg-gray-50 p-5 text-left"
      >
    ...
    <BaseButton
      class="mt-10 h-12 w-full text-base"
      :disabled="disabled"
      @click="emit('confirm')"
    >
      {{ displayedButtonText }}
